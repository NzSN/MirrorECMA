...
export interface WorkQueueAsyncPort {
  initialize(context: ReplayContext): Promise<void>;
  complete(context: ReplayContext): Promise<void>;
  enqueue(input: EnqueueInput, context: ReplayContext): Promise<void>;
  fail(context: ReplayContext): Promise<void>;
  reset(context: ReplayContext): Promise<void>;
  retry(context: ReplayContext): Promise<void>;
  start(context: ReplayContext): Promise<void>;
  observe(context: ReplayContext): Promise<WorkQueueObservation>;
}
...
export const WorkQueueAsyncTargetProfile = "mirrorecma-async-v1" as const;
export const WorkQueueAsyncStateComputerContractVersion = "mirrors.async-state-computer/v1" as const;
...
export const WorkQueuePublicManifest = {"actions":[{"id":"Complete","inputs":[]},{"id":"Enqueue","inputs":[{"id":"Item","type":{"kind":"int"}}]},{"id":"Fail","inputs":[]},{"id":"Reset","inputs":[]},{"id":"Retry","inputs":[]},{"id":"Start","inputs":[]}],"initializers":[{"id":"Initialize","inputs":[]}],"interfaceDigest":"3c646311c18341793bf7f09f0352b30c117fba8c424a0031e12bba4c77ebc2e2","observations":[{"id":"Completed","type":{"element":{"kind":"int"},"kind":"set"}},{"id":"Failed","type":{"kind":"bool"}},{"id":"InFlight","type":{"kind":"int"}},{"id":"Pending","type":{"element":{"kind":"int"},"kind":"seq"}}],"schema":"mirrorgate.port/v1"} as const;
...
function contextError(context: ReplayContext): WorkQueueBindingError | undefined {
...
export function assertWorkQueueCompatibleConfig(
...
export interface WorkQueueAsyncBinding {
...
export function bindWorkQueueAsync(
  port: WorkQueueAsyncPort,
  config: Pick<ApalacheConfig, "paramVars">,
): WorkQueueAsyncBinding {
  assertWorkQueueCompatibleConfig(config);
  ...
  const computer: AsyncStateComputer = async ({ action, payload, previous: _previous }, context) => {
    ...
    try {
      ...
      case "complete":
      {
        ...
        stage = "adapter";
        ensureContextActive(context);
        await awaitPortOperation(port.complete(context), context);
        ensureContextActive(context);
        ensureBindingActive();
      ...
      case "enqueue":
      {
        ...
        stage = "adapter";
        ensureContextActive(context);
        await awaitPortOperation(port.enqueue(input, context), context);
        ensureContextActive(context);
        ensureBindingActive();
        lifecycle = "initialized";
        actionId = "Enqueue";
      ...
      case "fail":
      {
        ...
        stage = "adapter";
        ensureContextActive(context);
        await awaitPortOperation(port.fail(context), context);
        ensureContextActive(context);
        ensureBindingActive();
        lifecycle = "initialized";
        actionId = "Fail";
      ...
      case "reset":
      {
        ...
        stage = "adapter";
        ensureContextActive(context);
        await awaitPortOperation(port.reset(context), context);
        ensureContextActive(context);
        ensureBindingActive();
        lifecycle = "initialized";
        actionId = "Reset";
      ...
      case "retry":
      {
        ...
        stage = "adapter";
        ensureContextActive(context);
        await awaitPortOperation(port.retry(context), context);
        ensureContextActive(context);
        ensureBindingActive();
        lifecycle = "initialized";
        actionId = "Retry";
      ...
      case "start":
      {
        ...
        stage = "adapter";
        ensureContextActive(context);
        await awaitPortOperation(port.start(context), context);
        ensureContextActive(context);
        ensureBindingActive();
        lifecycle = "initialized";
        actionId = "Start";
  ...
  return {
    computer,
    assertCompatibleConfig: assertWorkQueueCompatibleConfig,
...
export function bindWorkQueueAsyncPublicPort(
  publicPort: AsyncPublicPort,
  config: Pick<ApalacheConfig, "paramVars">,
): WorkQueueAsyncBinding {
  const port: WorkQueueAsyncPort = {
    initialize: (context) => {
      return publicPort.invoke("Initialize", Object.freeze(Object.create(null) as Record<string, unknown>), context);
    },
    complete: (context) => {
      return publicPort.invoke("Complete", Object.freeze(Object.create(null) as Record<string, unknown>), context);
    },
    enqueue: (input, context) => {
      const values = Object.create(null) as Record<string, unknown>;
      values["Item"] = input.item;
      return publicPort.invoke("Enqueue", Object.freeze(values), context);
    },
    fail: (context) => {
      return publicPort.invoke("Fail", Object.freeze(Object.create(null) as Record<string, unknown>), context);
    },
    reset: (context) => {
      return publicPort.invoke("Reset", Object.freeze(Object.create(null) as Record<string, unknown>), context);
    },
    retry: (context) => {
      return publicPort.invoke("Retry", Object.freeze(Object.create(null) as Record<string, unknown>), context);
    },
    start: (context) => {
      return publicPort.invoke("Start", Object.freeze(Object.create(null) as Record<string, unknown>), context);
    },
    observe: async (context) => {
      ...
      exactKeys(values, ["Completed", "Failed", "InFlight", "Pending"], "WorkQueuePublicObservation");
      return {
        completed: values["Completed"] as MirrorSet<bigint>,
        failed: values["Failed"] as boolean,
        inFlight: values["InFlight"] as bigint,
        pending: values["Pending"] as readonly (bigint)[],
      };
    },
  };
  return bindWorkQueueAsync(port, config);
}
