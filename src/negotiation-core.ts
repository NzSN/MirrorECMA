import { ReplayControlError } from "./replay-control.js";
...
export async function receiveNegotiatedFirstReply(
  ...
  try {
    ...
    if (cause instanceof ReplayCancelledError || cause instanceof ReplayDeadlineError ||
        cause instanceof ReplayControlError) throw cause;
